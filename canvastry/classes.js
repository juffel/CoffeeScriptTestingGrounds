...
(function() {
  var Grid, Square, calcGridCoords, clickMod, tmp, updateCoordinates;
  ...
  updateCoordinates = function(x, y) {
    var x_grid, y_grid, _ref;
    $("#x_coord").text(x);
    $("#y_coord").text(y);
    _ref = calcGridCoords(x, y), x_grid = _ref[0], y_grid = _ref[1];
    $("#x_grid").text(x_grid);
    return $("#y_grid").text(y_grid);
  };

  document.write("<p>Dies ist ein durch ein KaffeeSkript                erzeugter Paragraph</p>                <canvas id='dynCan' width='150' height='150'                style='border:1px solid #000000;'                onclick='window.canvyClick()'></canvas>                               <p>Grid: X: <b id='x_grid'> no x_grid </b> |                 Y: <b id='y_grid'> no y_grid </b></p>                <p>X: <b id='x_coord'> no x_value </b> |                Y: <b id='y_coord'> no y_value </b></p>");
